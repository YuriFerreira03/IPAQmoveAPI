...
const respostasDuracaoFrequenciaClassificacaoRoutes = async (server: FastifyInstance) => {
    server.get("/respostaCaminhadaDuracaoTotal", resp_caminhada_duracao_total);
    server.get("/respostaCaminhadaFrequenciaTotal", resp_caminhada_frequencia_total);
    server.get("/respostaModeradaDuracaoTotal", resp_moderada_duracao_total);
    server.get("/respostaModeradaFrequenciaTotal", resp_frequencia_moderada_total);
    server.get("/respostaVigorosaDuracaoTotal", resp_vigorosa_duracao_total);
    server.get("/respostaVigorosaFrequenciaTotal", resp_frequencia_vigorosa_total);
